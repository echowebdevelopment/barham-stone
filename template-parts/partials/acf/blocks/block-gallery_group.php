                            ...
                            <?php if( have_rows('photo_gallery') ): ?>
                                <div class="photo-gallery">
                                    ...
                                    ?>
                                      <div class="item">
                                            <?php if( $image ): ?>
                                              <a  href="<?php echo esc_url($image['url']); ?>" data-gallery="<?php echo $g_title; ?>" class="glightbox" data-title="<?php echo esc_html($title); ?>" data-description="<?php echo esc_html($description); ?>">
